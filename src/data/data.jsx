...
export const socialsList = [
  {
    name: "Github",
    link: "https://github.com/shri2310sti",
    icon: (
      <svg
        width="30px"
        height="30px"
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/shristi-shrivastava-969551251",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
  ...
  {
    name: "Leetcode",
    link: "https://leetcode.com/u/Shristi_233/",
    icon: (
      <svg
        fill="#FB923C"
        width="30px"
  ...
  {
    name: "GFG",
    link: "https://www.geeksforgeeks.org/user/shristurdz/",
    icon: (
      <svg
        fill="#32CD32"
        width="30px"
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M15.862 4.518L7.504 12.292 3.77 8.663 0 12.5l6.492 7.76 4.93-5.248 4.296 4.292 3.7-4.296-5.062-4.92-3.49 3.874z" />
      </svg>
    ),
  },
  ...
  
  {
    ...
    link: "https://www.naukri.com/code360/profile/shristi2310",
    icon: (
      <svg
        fill="#00A9D2"
        width="30px"
        ...
        viewBox="0 0 24 24"
      >
        <path d="M3 12l5-5 4 4 4-4 5 5-9 9z"></path>
      </svg>
    ),
  },
  ...
  {
    name: "Stack Overflow",
    link: "https://stackoverflow.com/users/29476042/shristi-223",
    icon: (
      <svg
        width="30px"
        height="30px"
...
export const projectData = [
  {
    ...
    description: "Python.",
    img: alexa,
    link: "https://github.com/shri2310sti/alexa",
  },
  {
    title: "Amazon Frontend Clone",
    description: "HTML, CSS.",
    img: amazon,
    link: "https://github.com/shri2310sti/Amazon-clone",
  },  
  {
    title: "Netflix Frontend Clone",
    description: "HTML, CSS.",
    img: netflix,
    link: "https://github.com/shri2310sti/Netflix-clone",
  },
...
export const about =
  "I am a Full Stack Developer with expertise in Java and Python, and foundational knowledge of C/C++. Currently, I am enhancing my skills in the MERN stack and Flutter, with a keen interest in mobile and web application development. In addition, I possess a basic understanding of machine learning and continuously strive to expand my knowledge in emerging technologies. My goal is to build innovative, high-quality applications while staying up-to-date with industry advancements.";
